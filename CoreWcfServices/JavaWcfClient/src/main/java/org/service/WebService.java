 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:51490/WebService.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:51490/WebService.asmx?WSDL");
    ...
    public WebServiceSoap getWebServiceSoap12() {
        return super.getPort(new QName("http://tempuri.org/", "WebServiceSoap12"), WebServiceSoap.class);
    }
    ...
    public WebServiceSoap getWebServiceSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "WebServiceSoap12"), WebServiceSoap.class, features);
    }
