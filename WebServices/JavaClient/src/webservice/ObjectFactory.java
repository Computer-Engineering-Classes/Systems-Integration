...
public class ObjectFactory {
    ...
    private final static QName _AverageNumbers_QNAME = new QName("http://tempuri.org/", "numbers");
    ...
    public JAXBElement<ArrayOfint> createAverageNumbers(ArrayOfint value) {
        return new JAXBElement<ArrayOfint>(_AverageNumbers_QNAME, ArrayOfint.class, Average.class, value);
    }
    ...
    public JAXBElement<ArrayOfint> createGetIndexNumbers(ArrayOfint value) {
        return new JAXBElement<ArrayOfint>(_AverageNumbers_QNAME, ArrayOfint.class, GetIndex.class, value);
    }
    ...
    public JAXBElement<ArrayOfint> createSumNumbers(ArrayOfint value) {
        return new JAXBElement<ArrayOfint>(_AverageNumbers_QNAME, ArrayOfint.class, Sum.class, value);
    }
    ...
    public JAXBElement<ArrayOfint> createMaxNumbers(ArrayOfint value) {
        return new JAXBElement<ArrayOfint>(_AverageNumbers_QNAME, ArrayOfint.class, Max.class, value);
    }
    ...
    public JAXBElement<ArrayOfint> createMinNumbers(ArrayOfint value) {
        return new JAXBElement<ArrayOfint>(_AverageNumbers_QNAME, ArrayOfint.class, Min.class, value);
    }
