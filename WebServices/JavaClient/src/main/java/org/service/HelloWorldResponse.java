...
public class HelloWorldResponse {
    ...
    @XmlElementRef(name = "HelloWorldResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public void setHelloWorldResult(JAXBElement<String> value) {
